 ...
 */
- (nullable instancetype)initFromAccountPubKey:(NSString* _Nullable)key;
 ...
 */
- (nullable instancetype)initFromAccountExtendedPublicKey:(NSString* _Nullable)acctPubKeyStr;
/**
 ...
 */
- (NSData* _Nullable)compressedPubKeyForPath:(CNBCnlibDerivationPath* _Nullable)path error:(NSError* _Nullable* _Nullable)error;
/**
 ...
 */
- (NSData* _Nullable)uncompressedPubKeyForPath:(CNBCnlibDerivationPath* _Nullable)path error:(NSError* _Nullable* _Nullable)error;
/**
 ...
 * NewBaseCoinFromAccountPubKey returns a new BaseCoin pointer based on prefix, or error if unrecognized.
 */
FOUNDATION_EXPORT CNBCnlibBaseCoin* _Nullable CNBCnlibNewBaseCoinFromAccountPubKey(NSString* _Nullable key, NSError* _Nullable* _Nullable error);
...
and unexported pointer to extended key for account-level extended master private key. Returns error if unable to parse x/y/zpub.
 */
FOUNDATION_EXPORT CNBCnlibHDWallet* _Nullable CNBCnlibNewHDWalletFromAccountExtendedPublicKey(NSString* _Nullable acctPubKeyStr, NSError* _Nullable* _Nullable error);
